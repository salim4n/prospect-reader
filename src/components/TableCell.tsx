...
import { phoneRegex, formatPhoneNumber, isValidPhoneNumber } from '../utils/phoneUtils';
...
export function TableCell({ content }: TableCellProps) {
  ...
  const domainMatch = trimmedContent.match(/^[a-zA-Z0-9][a-zA-Z0-9-]{1,61}[a-zA-Z0-9]\.[a-zA-Z]{2,}$/);
